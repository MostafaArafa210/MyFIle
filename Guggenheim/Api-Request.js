   ...
   ! function(T, l, y) {
      ...
      var n = T[t] || function(d) {
         ...
         function v(e, t) {
            ...
            return 
                   n[E + "id"] = a[b]()
                   /*(ai.device.id=="chorme") == true */
               ,   n[E + "type"] = a 
                  /*((ai.device.type) == Browser) == true */
               ,   n["ai.operation.name"] = S && S.pathname || "_unknown_"
                  /*((ai.operation.name==location) and location.pathname)  or print(_unknown_) */
               ,   n["ai.internal.sdkVersion"]  = "javascript:snippet_" + (m.sv || m.version),
                  /*ai.internal.sdkVersion == (javascript:snippet_5 or javascript:snippet_2 ) */
                {
               time: function() {
                  var e = new Date; /*TimePorprty(Data)*/
         ...
         if (h) {
            function a(e) {
               ...
               g = !0, m.queue = [], f || (f = !0, t = h, s = function() {
                  ...
                  "https://host.name.dc.services.visualstudio.com"
                  return e
      ...
      cfg: { // Application Insights Configuration
         connectionString: 'InstrumentationKey=a97dd27d-b158-47b7-9f7b-03ea1001b434'
