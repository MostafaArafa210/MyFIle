       ...
       var Z = {
          ...
          Ja: function(a, b) {
             var c = [16843776, 0, 65536, 16843780, 16842756, 66564, 4, 65536, 1024,
                ...
                d = [-2146402272, -2147450880, 32768, 1081376, 1048576, 32, -2146435040, -2147450848, -2147483616, -2146402272, -2146402304, -2147483648,
          ...
          m.api = {
             ...
             ds_cb: function(a) {
                ...
                if (Y = a) {
                   ...
                   d = /^\d+\.\d+\.\d+$/;
                   d.test(ha) && d.test(c) && ha.split(".")[0] === c.split(".")[0] || t("ver mismatch: ( S:" + ha + ", D:" + c + " )", void 0,
                      !0);
                   try {
