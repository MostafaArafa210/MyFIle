if (sessionStorage.getItem("ivFailed") == null) {
 ...
 function identityFn(callback) {
    callback({
       iss: "https://service.transunion.com",
       acr: "loa1",
       sub: ui.userInfo.userKey
    });
 }
 window.lpGetAuthenticationToken = function(callback) {
    var result = {
       ssoKey: btoa(userToken + "|" + visitToken),
       redirect_uri: "https://service.transunion.com/dss/liveperson.page"
    };
    callback(result);
 }